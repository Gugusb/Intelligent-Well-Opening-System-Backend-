...
import com.gugusb.hwics.conn.OPCUAChecker;
...
public class OpcuaService implements IOpcuaService {
    ...
    @Override
    public DataCheckResult checkPageData() throws Exception{
        OPCUAChecker example = new OPCUAChecker();
        return (new ClientConnectManagerRunner(example, true).run()).getDataCheckResult();
    }
